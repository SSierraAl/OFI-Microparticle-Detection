...
# ----- Understand the impact of the different parameters of the camera (to find the best configuration)
# ----- Function to trigger and capture the next or previous frames
# ----- Stop and Start the camera in an Easy way without bugs
# ----- Find one lamp that could help us for our experiments (check the lumens) could be the ring of leds and order it (could be the ring of leds or something like this one https://fr.rs-online.com/web/p/lampes-pour-machines-outils/2121679?cm_mmc=FR-PLA-DS3A-_-google-_-CSS_FR_FR_ePMax_Prio1-_--_-2121679&matchtype=&&gad_source=1&gclid=CjwKCAjwnK60BhA9EiwAmpHZw9NaNhuPyE_6Dn3sZRkUbXiPlQdIWDbpzl2Y7rCb7k0ze0_DYp9TSBoCD0gQAvD_BwE&gclsrc=aw.ds)
# ----- Test with real particles to set the maximum speed permited for the experiments
# ----- Think that at the end we need to correlate the signal of the laser and the camera in the same time for the particle
