       ...
       # Signal Acquisition
        ...
        for partition_number in range(1, cam.partition_count + 1):  # Iterate through all partitions
            ...
            while True:
                ...
                data_DAQ_filtered = butter_filter(data_DAQ_highpass, 200000, Laser_frequency, 3, "low")  # Adjusted cutoff frequency

                # Perform FFT on the acquired signal
                #fft_result = np.fft.fft(data_DAQ_filtered)
...
def main():
    ...
    cam.record()  # Use the record method to start recording
