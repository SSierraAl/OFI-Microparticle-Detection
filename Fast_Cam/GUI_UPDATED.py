...
#               Clean Up
#          September 20 2023
#          fix for 16bit and get both mono and color         
#
#*****************************************************************************/

'''
This takes a cine file and turns it into a matrix[image#][height][width]
...
for i in range(our_cine.range[0], our_cine.range[1]+1):                               #range is [first, last+1) so we get the whole range                               
    our_matrix.append(our_cine.get_images(utils.FrameRange(i,i), Option=1))                     #append get_images() of a frame range 1 image long to our matrix
...
def view_multi_image_matrix(matrix):
    print("Press p if you would like to get a specific pixel's value")
    print("Press c if you would like to change a specific pixel's value")
